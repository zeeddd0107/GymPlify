  ...
  const upcomingSessions = useMemo(() => {
    ...
    return sessions
      .filter((session) => {
        ...
        return sessionTime >= todayTime && sessionTime <= futureDate;
      })
      .sort((a, b) => {
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="text-sm text-gray-600 bg-transparent border-none outline-none cursor-pointer hover:text-gray-800 transition-colors"
            >
          ...
          <div className="space-y-4">
            {upcomingSessions.map((session) => {
              ...
              return (
                <div
                  key={session.id}
                  className="group p-4 border border-primary/50 rounded-lg hover:border-blue-300 hover:shadow-md transition-all duration-200 cursor-pointer"
                  onClick={async () => {
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-shrink-0">
                        <div
                          className={`w-12 h-12 rounded-lg flex flex-col items-center justify-center text-white font-semibold ${
                            isToday
                              ? "bg-green-500"
                              : isTomorrow
                                ? "bg-orange-500"
